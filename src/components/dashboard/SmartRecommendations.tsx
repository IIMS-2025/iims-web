...
const RecommendationCard: React.FC<RecommendationCardProps> = ({
  ...
  const getButtonClasses = () => {
    switch (type) {
      case "alert":
        return "absolute bottom-0 right-2 mt-3 px-3 py-1 bg-blue-700 text-white text-xs font-medium rounded-lg hover:bg-blue-700 transition-colors border border-blue-500 align-right";
      case "opportunity":
        return "absolute bottom-0 right-2 mt-3 px-3 py-1 bg-green-700 text-white text-xs font-medium rounded-lg hover:bg-green-700 transition-colors border border-green-500 align-right";
      case "prevention":
        return "absolute bottom-0 right-2 mt-3 px-3 py-1 bg-orange-700 text-white text-xs font-medium rounded-lg hover:bg-orange-700 transition-colors border border-orange-500 align-right";
      default:
        return "absolute bottom-0 right-2 mt-3 px-3 py-1 bg-gray-100 text-gray-700 text-xs font-medium rounded-lg hover:bg-gray-200 transition-colors border border-gray-500 align-right";
    }
  };
  ...
  return (
    <div className={getRecommendationCardClasses(type)}>
      <div className="flex items-start gap-3 w-[100%] min-h-[120px] relative">
